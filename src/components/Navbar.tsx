...
export default function Navbar({ location }: Props) {
  ...
  return (
    <>
      <nav className="bg-white bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 shadow-sm  sticky top-0 left-0 z-50 h-[10vh]">
        <div className="h-[80px] w-full flex justify-between items-center max-w-7xl px-3 mx-auto">
          <p className="flex items-center justify-center gap-2  ">
            <h2 className="text-black font-bold text-3xl">{place}</h2>
